      ...
      <div className="bg-white rounded-3xl border max-w-2xl w-full p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="space-y-5">
          <div className="flex items-start justify-between border-b pb-4">
            <div>
              <div className="text-xl font-bold text-[#0f2240]">{item.number}</div>
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
            ...
            {item.description && (
              <>
                <div className="text-[10px] font-bold text-slate-400 uppercase mb-1">Забележка</div>
            ...
            <div className={`p-4 rounded-xl border ${finalOrder ? 'bg-emerald-50 border-emerald-200' : 'bg-orange-50 border-orange-200'}`}>
              {finalOrder ? (
                <div className="flex items-center gap-2 text-emerald-700">
                  ...
                  <div>
                    <div className="text-xs font-bold">Заповедта е регистрирана!</div>
                    <div className="text-[11px] font-bold mt-0.5">{finalOrder}</div>
                  </div>
                </div>
              ) : (
