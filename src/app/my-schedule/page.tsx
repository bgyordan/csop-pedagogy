...
export default async function MySchedulePage({
  ...
  // ── 1. Паралелките, на които е класен ──
  ...
  // Разписанията на тези паралелки за срока
  let classSlots: any[] = []
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl md:text-2xl font-semibold text-slate-800">Моето разписание</h1>
